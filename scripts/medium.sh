...
for domain in $(cat $1); do
	#Subdomain Enum
	echo -e "\n[+] ****************Started Subdomain Enumeration for $domain****************"
	$dir/subdomains.sh $domain;
	echo -e "\n[+] ****************Completed****************"
	#Probing
	echo -e "\n[+] ****************Started Subdomain Probing for $domain****************"
	$dir/probing.sh $domain;
	echo -e "\n[+] ****************Completed****************"
	#port scan
	...
	echo -e "\n[+] ****************Completed****************"
	#Takeover
	echo -e "\n[+] ****************Started Subdomain Takeover for $domain****************"
	...
	echo "Medium Scan completed for $domain" | notify
done